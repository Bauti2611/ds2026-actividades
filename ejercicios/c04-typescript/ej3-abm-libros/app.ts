...
const formLibro = document.getElementById("formLibro") as HTMLFormElement;
...
const checkDisponible = document.getElementById("checkDisponible") as HTMLInputElement;
...
function validarYObtenerLibro(): Libro | null {
